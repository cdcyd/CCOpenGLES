//
//  MultipleTextureViewController.m
//  CCOpenGLES
//
...
#import "MultipleTextureViewController.h"

#define BUFFER_OFFSET(i) ((char *)NULL + (i))

@interface MultipleTextureViewController ()
{
    GLuint  _VBO;
    GLfloat _rotation;
}
...
@implementation MultipleTextureViewController
...
-(void)setupGL{
    ...
    glTexParameteri(textureInfo1.target, GL_TEXTURE_WRAP_S, GL_REPEAT);
    glTexParameteri(textureInfo1.target, GL_TEXTURE_WRAP_T, GL_REPEAT);
